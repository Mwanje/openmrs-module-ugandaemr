...
public class UgandaEMRConstants {
    ...
    public static final String HIV_ELIGIBILITY_QUERY = "select DISTINCT person_id from obs  where concept_id=175333 and value_coded=703\n" +
            "            and person_id not in (select person_id from obs  where concept_id=175333 and value_coded=703) and\n" +
